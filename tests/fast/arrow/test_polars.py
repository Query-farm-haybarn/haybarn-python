...
from haybarn.polars_io import _pl_tree_to_sql, _predicate_to_expression  # noqa: E402
...
class TestPolars:
    ...
    def test_register_polars(self, duckdb_cursor):
        ...
        with pytest.raises(haybarn.CatalogException, match="Table with name polars_df does not exist"):
    ...
    def test_empty_polars_dataframe(self, duckdb_cursor):
        ...
        with pytest.raises(
            haybarn.InvalidInputException, match="Provided table/dataframe must have at least one column"
        ):
    ...
    def test_polars_from_json_error_2(self, duckdb_cursor):
        ...
        my_res = haybarn.query("select my_str from my_table where my_str != 'y'")
    ...
    def test_expr_with_sql_in_string_node(self, input_str):
        ...
        expected = str(haybarn.ConstantExpression(input_str))
