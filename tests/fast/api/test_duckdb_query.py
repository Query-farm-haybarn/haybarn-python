...
class TestDuckDBQuery:
    ...
    def test_named_param_mixed(self):
        ...
        with pytest.raises(
            haybarn.NotImplementedException, match="Mixing named and positional parameters is not supported yet"
        ):
    ...
    def test_conversion_from_tuple(self):
        ...
        with pytest.raises(haybarn.InvalidInputException, match="Can't convert tuple to a Value of type VARCHAR"):
